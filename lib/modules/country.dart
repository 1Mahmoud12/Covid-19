...
import '../shared/network/styles/color.dart';
                    ...
                    children: [
                      Expanded(
                        child: MaterialButton(
                          onPressed: ()async{
                            CovidCubit.get(context).getSpecificCountries(countryData['country']);
                          CovidCubit.get(context).changeScreen(0);
                          navigatorReuse(context, const HomeLayout());
                            CashHelper.putData(key:'country',value:countryData['country']);


                          },
                          color:defaultColor,
                          child:  Text('Set as default',style: Theme.of(context).textTheme.bodyText1,),
